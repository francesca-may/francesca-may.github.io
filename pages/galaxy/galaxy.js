...
const generateGalaxy = () => {
    ...
    if (points !== null){
        ...
        geometry.dispose();
        material.dispose();
        // Can't dispose, so remove points from scene
        scene.remove(points);
    }
    ...
    for (let i = 0; i < parameters.count; i++) {
        ...
        // % = modulo - will never hit the number
        // e.g. % 3 = 0 1 2, 0 1 2, 0 1 2
 ...
 * HTML Elements
 */
const galaxyHomeBtn = document.getElementById("galaxyHomeBtn");
galaxyHomeBtn.addEventListener("click", () => {
